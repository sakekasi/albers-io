...
Elm.ColorSwatch = Elm.ColorSwatch || {};
Elm.ColorSwatch.make = function (_elm) {
   "use strict";
   _elm.ColorSwatch = _elm.ColorSwatch || {};
   if (_elm.ColorSwatch.values) return _elm.ColorSwatch.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var toCss = function (color) {
      var rgb = $Color.toRgb(color);
      return $String.concat(_U.list(["rgb(",$Basics.toString(rgb.red),",",$Basics.toString(rgb.green),",",$Basics.toString(rgb.blue),")"]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("swatch")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: toCss(model)}
                                              ,{ctor: "_Tuple2",_0: "width",_1: "50px"}
                                              ,{ctor: "_Tuple2",_0: "height",_1: "50px"}]))]),
      _U.list([]));
   });
   var update = F2(function (_p0,x) {    return x;});
   return _elm.ColorSwatch.values = {_op: _op,update: update,view: view,toCss: toCss};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $ColorSwatch = Elm.ColorSwatch.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: $Color.green,view: $ColorSwatch.view,update: $ColorSwatch.update});
